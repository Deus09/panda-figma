  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#1A1A1A] text-white">
      ...
      <div className="flex-1 px-4 py-6 pb-32 overflow-y-auto">
        {/* Kullanıcı Kimliği ve Genel Bakış */}
        <div className="bg-[#222] rounded-[20px] p-6 mb-6 shadow-lg">
          ...
          <div className="flex flex-col items-center mb-6">
            <div className="relative mb-4">
              <img
                ...
                alt="Profile"
                className="w-24 h-24 rounded-full object-cover border-4 border-[#FE7743]"
              />
              {isEditing && (
                <button
                  onClick={() => fileInputRef.current?.click()}
                  className="absolute -bottom-2 -right-2 w-8 h-8 bg-[#FE7743] rounded-full flex items-center justify-center text-white hover:bg-[#E56A3C] transition-colors"
                >
            ...
            {isEditing && (
              <div className="w-full">
                <p className="text-[#FE7743] text-sm mb-3 text-center">Avatar Galerisi</p>
            ...
            {isEditing ? (
              <div className="space-y-3">
                <input
                  ...
                  className="w-full bg-[#333] text-white text-xl font-bold text-center rounded-lg px-3 py-2 border border-gray-600 focus:border-[#FE7743] focus:outline-none"
                ...
                <input
                  ...
                  className="w-full bg-[#333] text-white text-lg text-center rounded-lg px-3 py-2 border border-gray-600 focus:border-[#FE7743] focus:outline-none"
                  placeholder="Gerçek Adınız (İsteğe bağlı)"
                />
              </div>
            ) : (
              <>
          ...
          {/* Hakkında Bölümü */}
          <div className="mb-4">
            <p className="text-[#FE7743] text-sm font-medium mb-2 font-poppins">Hakkında</p>
            {isEditing ? (
              <textarea
                value={editData.bio}
                onChange={(e) => setEditData(prev => ({ ...prev, bio: e.target.value }))}
                className="w-full bg-[#333] text-white rounded-lg px-3 py-2 border border-gray-600 focus:border-[#FE7743] focus:outline-none resize-none"
                rows={3}
                placeholder="Kendinizi tanıtın... (Örn: Tarantino filmleri ve 80'ler korku sineması hayranı)"
              />
            ) : (
          ...
          {/* Favori Türler */}
          <div className="mb-4">
            <p className="text-[#FE7743] text-sm font-medium mb-2 font-poppins">Favori Türler</p>
            {isEditing ? (
